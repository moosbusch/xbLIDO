 ...
 */
public class TimeTopologyComplexPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeTopologyComplexPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeTopologyComplexPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeTopologyComplex()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMETOPOLOGYCOMPLEX$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeTopologyComplex()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMETOPOLOGYCOMPLEX$0, 0);
        }
    }
