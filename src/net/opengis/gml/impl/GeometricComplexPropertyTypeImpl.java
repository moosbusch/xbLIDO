 ...
 */
public class GeometricComplexPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeometricComplexPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public GeometricComplexPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COMPOSITECURVE$2 = 
        new javax.xml.namespace.QName("http://www.opengis.net/gml", "CompositeCurve");
    private static final javax.xml.namespace.QName COMPOSITESURFACE$4 = 
        new javax.xml.namespace.QName("http://www.opengis.net/gml", "CompositeSurface");
    private static final javax.xml.namespace.QName COMPOSITESOLID$6 = 
    ...
    public boolean isSetGeometricComplex()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOMETRICCOMPLEX$0) != 0;
        }
    }
    ...
    public void unsetGeometricComplex()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GEOMETRICCOMPLEX$0, 0);
        }
    }
    ...
    public net.opengis.gml.CompositeCurveType getCompositeCurve()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.CompositeCurveType)get_store().find_element_user(COMPOSITECURVE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetCompositeCurve()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOSITECURVE$2) != 0;
        }
    }
    ...
    public net.opengis.gml.CompositeCurveType addNewCompositeCurve()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.CompositeCurveType target = null;
            target = (net.opengis.gml.CompositeCurveType)get_store().add_element_user(COMPOSITECURVE$2);
            return target;
        }
    }
    ...
    public void unsetCompositeCurve()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COMPOSITECURVE$2, 0);
        }
    }
    ...
    public net.opengis.gml.CompositeSurfaceType getCompositeSurface()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.CompositeSurfaceType)get_store().find_element_user(COMPOSITESURFACE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetCompositeSurface()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOSITESURFACE$4) != 0;
        }
    }
    ...
    public net.opengis.gml.CompositeSurfaceType addNewCompositeSurface()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.CompositeSurfaceType target = null;
            target = (net.opengis.gml.CompositeSurfaceType)get_store().add_element_user(COMPOSITESURFACE$4);
            return target;
        }
    }
    ...
    public void unsetCompositeSurface()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COMPOSITESURFACE$4, 0);
        }
    }
    ...
    public net.opengis.gml.CompositeSolidType getCompositeSolid()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.CompositeSolidType)get_store().find_element_user(COMPOSITESOLID$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetCompositeSolid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOSITESOLID$6) != 0;
        }
    }
    ...
    public net.opengis.gml.CompositeSolidType addNewCompositeSolid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.CompositeSolidType target = null;
            target = (net.opengis.gml.CompositeSolidType)get_store().add_element_user(COMPOSITESOLID$6);
            return target;
        }
    }
    ...
    public void unsetCompositeSolid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COMPOSITESOLID$6, 0);
        }
    }
