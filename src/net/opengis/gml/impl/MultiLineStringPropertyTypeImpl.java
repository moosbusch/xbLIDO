 ...
 */
public class MultiLineStringPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.MultiLineStringPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MultiLineStringPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMultiLineString()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MULTILINESTRING$0) != 0;
        }
    }
