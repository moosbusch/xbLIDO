 ...
 */
public class CompositeCurvePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CompositeCurvePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CompositeCurvePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCompositeCurve()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOSITECURVE$0) != 0;
        }
    }
    ...
    public void unsetCompositeCurve()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COMPOSITECURVE$0, 0);
        }
    }
