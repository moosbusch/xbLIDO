 ...
 */
public class LinearCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.LinearCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public LinearCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLinearCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LINEARCS$0) != 0;
        }
    }
    ...
    public void unsetLinearCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(LINEARCS$0, 0);
        }
    }
