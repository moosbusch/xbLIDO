 ...
 */
public class OperationParameterRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.OperationParameterRefType
{
    private static final long serialVersionUID = 1L;
    
    public OperationParameterRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetOperationParameter()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OPERATIONPARAMETER$0) != 0;
        }
    }
     ...
     */
     public void setOperationParameter(net.opengis.gml.OperationParameterType operationParameter)
    {
     ...
     */
    public void unsetOperationParameter()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(OPERATIONPARAMETER$0, 0);
        }
    }
