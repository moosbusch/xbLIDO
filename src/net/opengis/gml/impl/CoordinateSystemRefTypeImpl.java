 ...
 */
public class CoordinateSystemRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CoordinateSystemRefType
{
    private static final long serialVersionUID = 1L;
    
    public CoordinateSystemRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCoordinateSystem()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COORDINATESYSTEM$1) != 0;
        }
    }
     ...
     */
     public void setCoordinateSystem(net.opengis.gml.AbstractCoordinateSystemType coordinateSystem)
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetCoordinateSystem()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COORDINATESYSTEM$1, 0);
        }
    }
