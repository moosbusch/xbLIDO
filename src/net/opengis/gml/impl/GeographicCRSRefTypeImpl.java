 ...
 */
public class GeographicCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeographicCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public GeographicCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeographicCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOGRAPHICCRS$0) != 0;
        }
    }
     ...
     */
     public void setGeographicCRS(net.opengis.gml.GeographicCRSType geographicCRS)
    {
     ...
     */
    public void unsetGeographicCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(GEOGRAPHICCRS$0, 0);
        }
    }
