 ...
 */
public class PrimeMeridianRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.PrimeMeridianRefType
{
    private static final long serialVersionUID = 1L;
    
    public PrimeMeridianRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetPrimeMeridian()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PRIMEMERIDIAN$0) != 0;
        }
    }
     ...
     */
    @Inject(optional=true) public void setPrimeMeridian(net.opengis.gml.PrimeMeridianType primeMeridian)
    {
    ...
    public void unsetPrimeMeridian()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PRIMEMERIDIAN$0, 0);
        }
    }
