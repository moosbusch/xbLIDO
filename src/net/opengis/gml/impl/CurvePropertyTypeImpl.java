 ...
 */
public class CurvePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CurvePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CurvePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCurve()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CURVE$1) != 0;
        }
    }
    ...
    public void unsetCurve()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CURVE$1, 0);
        }
    }
