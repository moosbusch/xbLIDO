 ...
 */
public class PolarCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.PolarCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public PolarCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetPolarCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(POLARCS$0) != 0;
        }
    }
    ...
    public void unsetPolarCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(POLARCS$0, 0);
        }
    }
