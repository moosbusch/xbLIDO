 ...
 */
public class GeocentricCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeocentricCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public GeocentricCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeocentricCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOCENTRICCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetGeocentricCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(GEOCENTRICCRS$0, 0);
        }
    }
