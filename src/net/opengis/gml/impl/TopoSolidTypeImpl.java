 ...
 */
public class TopoSolidTypeImpl extends net.opengis.gml.impl.AbstractTopoPrimitiveTypeImpl implements net.opengis.gml.TopoSolidType
{
    ...
    public java.util.List<net.opengis.gml.DirectedFacePropertyType> getDirectedFaceList()
    {
        final class DirectedFaceList extends java.util.AbstractList<net.opengis.gml.DirectedFacePropertyType>
        {
            ...
            public net.opengis.gml.DirectedFacePropertyType get(int i)
                { return TopoSolidTypeImpl.this.getDirectedFaceArray(i); }
            
            @Override
            public net.opengis.gml.DirectedFacePropertyType set(int i, net.opengis.gml.DirectedFacePropertyType o)
            {
                net.opengis.gml.DirectedFacePropertyType old = TopoSolidTypeImpl.this.getDirectedFaceArray(i);
                TopoSolidTypeImpl.this.setDirectedFaceArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, net.opengis.gml.DirectedFacePropertyType o)
                { TopoSolidTypeImpl.this.insertNewDirectedFace(i).set(o); }
            
            @Override
            public net.opengis.gml.DirectedFacePropertyType remove(int i)
            {
                net.opengis.gml.DirectedFacePropertyType old = TopoSolidTypeImpl.this.getDirectedFaceArray(i);
                TopoSolidTypeImpl.this.removeDirectedFace(i);
                return old;
            }
            
            @Override
            public int size()
                { return TopoSolidTypeImpl.this.sizeOfDirectedFaceArray(); }
