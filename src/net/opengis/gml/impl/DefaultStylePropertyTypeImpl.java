 ...
 */
public class DefaultStylePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.DefaultStylePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DefaultStylePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetStyle()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(STYLE$1) != 0;
        }
    }
    ...
    public void unsetStyle()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(STYLE$1, 0);
        }
    }
