 ...
 */
public class TopoComplexMemberTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TopoComplexMemberType
{
    private static final long serialVersionUID = 1L;
    
    public TopoComplexMemberTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTopoComplex()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TOPOCOMPLEX$0) != 0;
        }
    }
     ...
     */
    public void unsetTopoComplex()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TOPOCOMPLEX$0, 0);
        }
    }
