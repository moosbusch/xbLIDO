 ...
 */
public class TimePrimitivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimePrimitivePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimePrimitivePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimePrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMEPRIMITIVE$1) != 0;
        }
    }
     ...
     */
    public void unsetTimePrimitive()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMEPRIMITIVE$1, 0);
        }
    }
