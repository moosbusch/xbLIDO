 ...
 */
public class TopologyStylePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TopologyStylePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TopologyStylePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTopologyStyle()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TOPOLOGYSTYLE$0) != 0;
        }
    }
    ...
    public void unsetTopologyStyle()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(TOPOLOGYSTYLE$0, 0);
        }
    }
