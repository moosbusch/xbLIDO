 ...
 */
public class MultiGeometryPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.MultiGeometryPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MultiGeometryPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeometricAggregate()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOMETRICAGGREGATE$1) != 0;
        }
    }
    ...
    public void unsetGeometricAggregate()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GEOMETRICAGGREGATE$1, 0);
        }
    }
