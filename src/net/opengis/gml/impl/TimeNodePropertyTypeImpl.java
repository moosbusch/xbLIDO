 ...
 */
public class TimeNodePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeNodePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeNodePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeNode()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMENODE$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeNode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMENODE$0, 0);
        }
    }
