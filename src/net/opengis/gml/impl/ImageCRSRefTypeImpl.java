 ...
 */
public class ImageCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ImageCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public ImageCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetImageCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(IMAGECRS$0) != 0;
        }
    }
     ...
     */
    public void unsetImageCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(IMAGECRS$0, 0);
        }
    }
