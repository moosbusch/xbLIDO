 ...
 */
public class DictionaryEntryTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.DictionaryEntryType
{
    private static final long serialVersionUID = 1L;
    
    public DictionaryEntryTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDefinition()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DEFINITION$1) != 0;
        }
    }
    ...
    public void unsetDefinition()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(DEFINITION$1, 0);
        }
    }
