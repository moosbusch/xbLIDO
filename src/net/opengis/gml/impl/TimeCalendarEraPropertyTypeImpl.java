 ...
 */
public class TimeCalendarEraPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeCalendarEraPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeCalendarEraPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeCalendarEra()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMECALENDARERA$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeCalendarEra()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMECALENDARERA$0, 0);
        }
    }
