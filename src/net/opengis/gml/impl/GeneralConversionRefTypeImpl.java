 ...
 */
public class GeneralConversionRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeneralConversionRefType
{
    private static final long serialVersionUID = 1L;
    
    public GeneralConversionRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeneralConversion()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GENERALCONVERSION$1) != 0;
        }
    }
     ...
     */
    public void unsetGeneralConversion()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(GENERALCONVERSION$1, 0);
        }
    }
