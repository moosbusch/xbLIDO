 ...
 */
public class TimeEdgePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeEdgePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeEdgePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeEdge()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMEEDGE$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeEdge()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMEEDGE$0, 0);
        }
    }
