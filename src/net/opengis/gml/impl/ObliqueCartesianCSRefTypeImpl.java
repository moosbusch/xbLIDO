 ...
 */
public class ObliqueCartesianCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ObliqueCartesianCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public ObliqueCartesianCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetObliqueCartesianCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OBLIQUECARTESIANCS$0) != 0;
        }
    }
     ...
     */
    public void unsetObliqueCartesianCS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(OBLIQUECARTESIANCS$0, 0);
        }
    }
