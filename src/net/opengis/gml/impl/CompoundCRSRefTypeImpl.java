 ...
 */
public class CompoundCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CompoundCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public CompoundCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCompoundCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOUNDCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetCompoundCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COMPOUNDCRS$0, 0);
        }
    }
