 ...
 */
public class GeometricPrimitivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeometricPrimitivePropertyType
{
    ...
    public boolean isSetGeometricPrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOMETRICPRIMITIVE$1) != 0;
        }
    }
    ...
    public void unsetGeometricPrimitive()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GEOMETRICPRIMITIVE$1, 0);
        }
    }
