 ...
 */
public class ConeTypeImpl extends net.opengis.gml.impl.AbstractGriddedSurfaceTypeImpl implements net.opengis.gml.ConeType
{
    private static final long serialVersionUID = 1L;
    
    public ConeTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
