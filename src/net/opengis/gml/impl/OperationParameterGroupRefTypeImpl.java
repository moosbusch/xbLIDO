 ...
 */
public class OperationParameterGroupRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.OperationParameterGroupRefType
{
    private static final long serialVersionUID = 1L;
    
    public OperationParameterGroupRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetOperationParameterGroup()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OPERATIONPARAMETERGROUP$0) != 0;
        }
    }
     ...
     */
     public void setOperationParameterGroup(net.opengis.gml.OperationParameterGroupType operationParameterGroup)
    {
     ...
     */
    public void unsetOperationParameterGroup()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(OPERATIONPARAMETERGROUP$0, 0);
        }
    }
