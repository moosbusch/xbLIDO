 ...
 */
public class TimeTopologyPrimitivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeTopologyPrimitivePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeTopologyPrimitivePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeTopologyPrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMETOPOLOGYPRIMITIVE$1) != 0;
        }
    }
     ...
     */
     public void setTimeTopologyPrimitive(net.opengis.gml.AbstractTimeTopologyPrimitiveType timeTopologyPrimitive)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void unsetTimeTopologyPrimitive()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMETOPOLOGYPRIMITIVE$1, 0);
        }
    }
