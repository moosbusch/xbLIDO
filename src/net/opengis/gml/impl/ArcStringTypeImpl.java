 ...
 */
public class ArcStringTypeImpl extends net.opengis.gml.impl.AbstractCurveSegmentTypeImpl implements net.opengis.gml.ArcStringType
{
    private static final long serialVersionUID = 1L;
    
    public ArcStringTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<net.opengis.gml.DirectPositionType> getPositionList()
    {
        final class PosList extends java.util.AbstractList<net.opengis.gml.DirectPositionType>
        {
            ...
            public net.opengis.gml.DirectPositionType get(int i)
                { return ArcStringTypeImpl.this.getPosArray(i); }
            
            @Override
            public net.opengis.gml.DirectPositionType set(int i, net.opengis.gml.DirectPositionType o)
            {
                net.opengis.gml.DirectPositionType old = ArcStringTypeImpl.this.getPosArray(i);
                ArcStringTypeImpl.this.setPosArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, net.opengis.gml.DirectPositionType o)
                { ArcStringTypeImpl.this.insertNewPos(i).set(o); }
            
            @Override
            public net.opengis.gml.DirectPositionType remove(int i)
            {
                net.opengis.gml.DirectPositionType old = ArcStringTypeImpl.this.getPosArray(i);
                ArcStringTypeImpl.this.removePos(i);
                return old;
            }
            
            @Override
            public int size()
                { return ArcStringTypeImpl.this.sizeOfPosArray(); }
    ...
    public java.util.List<net.opengis.gml.PointPropertyType> getPointPropertyList()
    {
        final class PointPropertyList extends java.util.AbstractList<net.opengis.gml.PointPropertyType>
        {
            ...
            public net.opengis.gml.PointPropertyType get(int i)
                { return ArcStringTypeImpl.this.getPointPropertyArray(i); }
            
            @Override
            public net.opengis.gml.PointPropertyType set(int i, net.opengis.gml.PointPropertyType o)
            {
                net.opengis.gml.PointPropertyType old = ArcStringTypeImpl.this.getPointPropertyArray(i);
                ArcStringTypeImpl.this.setPointPropertyArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, net.opengis.gml.PointPropertyType o)
                { ArcStringTypeImpl.this.insertNewPointProperty(i).set(o); }
            
            @Override
            public net.opengis.gml.PointPropertyType remove(int i)
            {
                net.opengis.gml.PointPropertyType old = ArcStringTypeImpl.this.getPointPropertyArray(i);
                ArcStringTypeImpl.this.removePointProperty(i);
                return old;
            }
            
            @Override
            public int size()
                { return ArcStringTypeImpl.this.sizeOfPointPropertyArray(); }
    ...
    public java.util.List<net.opengis.gml.PointPropertyType> getPointRepList()
    {
        final class PointRepList extends java.util.AbstractList<net.opengis.gml.PointPropertyType>
        {
            @Override
            public net.opengis.gml.PointPropertyType get(int i)
                { return ArcStringTypeImpl.this.getPointRepArray(i); }
            
            @Override
            public net.opengis.gml.PointPropertyType set(int i, net.opengis.gml.PointPropertyType o)
            {
                net.opengis.gml.PointPropertyType old = ArcStringTypeImpl.this.getPointRepArray(i);
                ArcStringTypeImpl.this.setPointRepArray(i, o);
                return old;
            }
            
            @Override
            public void add(int i, net.opengis.gml.PointPropertyType o)
                { ArcStringTypeImpl.this.insertNewPointRep(i).set(o); }
            
            @Override
            public net.opengis.gml.PointPropertyType remove(int i)
            {
                net.opengis.gml.PointPropertyType old = ArcStringTypeImpl.this.getPointRepArray(i);
                ArcStringTypeImpl.this.removePointRep(i);
                return old;
            }
            
            @Override
            public int size()
                { return ArcStringTypeImpl.this.sizeOfPointRepArray(); }
    ...
    public boolean isSetNumArc()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(NUMARC$12) != null;
        }
    }
    ...
    public void unsetNumArc()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(NUMARC$12);
        }
    }
}
