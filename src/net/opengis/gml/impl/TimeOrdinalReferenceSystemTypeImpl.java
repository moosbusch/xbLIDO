...
public class TimeOrdinalReferenceSystemTypeImpl extends net.opengis.gml.impl.AbstractTimeReferenceSystemTypeImpl implements net.opengis.gml.TimeOrdinalReferenceSystemType
{
     ...
     */
     public void setComponentArray(net.opengis.gml.TimeOrdinalEraPropertyType[] componentArray)
    {
        check_orphaned();
     ...
     */
     public void setComponentArray(int i, net.opengis.gml.TimeOrdinalEraPropertyType component)
    {
