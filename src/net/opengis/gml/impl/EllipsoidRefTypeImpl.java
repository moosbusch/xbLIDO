 ...
 */
public class EllipsoidRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.EllipsoidRefType
{
    private static final long serialVersionUID = 1L;
    
    public EllipsoidRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEllipsoid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ELLIPSOID$0) != 0;
        }
    }
    ...
    public void unsetEllipsoid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ELLIPSOID$0, 0);
        }
    }
