 ...
 */
public class EngineeringDatumRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.EngineeringDatumRefType
{
    private static final long serialVersionUID = 1L;
    
    public EngineeringDatumRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEngineeringDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ENGINEERINGDATUM$0) != 0;
        }
    }
     ...
     */
    public void unsetEngineeringDatum()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ENGINEERINGDATUM$0, 0);
        }
    }
