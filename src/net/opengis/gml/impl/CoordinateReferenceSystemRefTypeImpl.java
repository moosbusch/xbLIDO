 ...
 */
public class CoordinateReferenceSystemRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CoordinateReferenceSystemRefType
{
    private static final long serialVersionUID = 1L;
    
    public CoordinateReferenceSystemRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCoordinateReferenceSystem()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COORDINATEREFERENCESYSTEM$1) != 0;
        }
    }
     ...
     */
    public void unsetCoordinateReferenceSystem()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COORDINATEREFERENCESYSTEM$1, 0);
        }
    }
