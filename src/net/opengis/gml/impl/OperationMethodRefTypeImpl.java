 ...
 */
public class OperationMethodRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.OperationMethodRefType
{
    private static final long serialVersionUID = 1L;
    
    public OperationMethodRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetOperationMethod()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OPERATIONMETHOD$0) != 0;
        }
    }
    ...
    public void unsetOperationMethod()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(OPERATIONMETHOD$0, 0);
        }
    }
