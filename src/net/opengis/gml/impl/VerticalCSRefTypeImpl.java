 ...
 */
public class VerticalCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.VerticalCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public VerticalCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetVerticalCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(VERTICALCS$0) != 0;
        }
    }
     ...
     */
    public void unsetVerticalCS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(VERTICALCS$0, 0);
        }
    }
