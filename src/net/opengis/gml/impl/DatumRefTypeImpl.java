 ...
 */
public class DatumRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.DatumRefType
{
    private static final long serialVersionUID = 1L;
    
    public DatumRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DATUM$1) != 0;
        }
    }
    ...
    public void unsetDatum()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(DATUM$1, 0);
        }
    }
