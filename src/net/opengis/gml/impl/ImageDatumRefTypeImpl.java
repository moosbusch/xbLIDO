 ...
 */
public class ImageDatumRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ImageDatumRefType
{
    private static final long serialVersionUID = 1L;
    
    public ImageDatumRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetImageDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(IMAGEDATUM$0) != 0;
        }
    }
     ...
     */
    public void unsetImageDatum()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(IMAGEDATUM$0, 0);
        }
    }
