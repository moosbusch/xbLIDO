 ...
 */
public class UserDefinedCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.UserDefinedCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public UserDefinedCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetUserDefinedCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(USERDEFINEDCS$0) != 0;
        }
    }
     ...
     */
     public void setUserDefinedCS(net.opengis.gml.UserDefinedCSType userDefinedCS)
    {
    ...
    public void unsetUserDefinedCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(USERDEFINEDCS$0, 0);
        }
    }
