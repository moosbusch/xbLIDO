 ...
 */
public class AbstractGeneralOperationParameterRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.AbstractGeneralOperationParameterRefType
{
    private static final long serialVersionUID = 1L;
    
    public AbstractGeneralOperationParameterRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeneralOperationParameter()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GENERALOPERATIONPARAMETER$1) != 0;
        }
    }
    ...
    public void unsetGeneralOperationParameter()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GENERALOPERATIONPARAMETER$1, 0);
        }
    }
