 ...
 */
public class TemporalDatumRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TemporalDatumRefType
{
    private static final long serialVersionUID = 1L;
    
    public TemporalDatumRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTemporalDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TEMPORALDATUM$0) != 0;
        }
    }
     ...
     */
     public void setTemporalDatum(net.opengis.gml.TemporalDatumType temporalDatum)
    {
     ...
     */
    public void unsetTemporalDatum()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TEMPORALDATUM$0, 0);
        }
    }
