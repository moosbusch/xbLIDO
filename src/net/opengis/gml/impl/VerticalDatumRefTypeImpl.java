 ...
 */
public class VerticalDatumRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.VerticalDatumRefType
{
    private static final long serialVersionUID = 1L;
    
    public VerticalDatumRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetVerticalDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(VERTICALDATUM$0) != 0;
        }
    }
    ...
    public void unsetVerticalDatum()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(VERTICALDATUM$0, 0);
        }
    }
