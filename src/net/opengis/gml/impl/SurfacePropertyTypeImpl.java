 ...
 */
public class SurfacePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.SurfacePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public SurfacePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetSurface()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SURFACE$1) != 0;
        }
    }
     ...
     */
    @Inject(optional=true) public void setSurface(net.opengis.gml.AbstractSurfaceType surface)
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetSurface()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SURFACE$1, 0);
        }
    }
