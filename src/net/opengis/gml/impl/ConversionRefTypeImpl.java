 ...
 */
public class ConversionRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ConversionRefType
{
    private static final long serialVersionUID = 1L;
    
    public ConversionRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetConversion()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CONVERSION$0) != 0;
        }
    }
    ...
    public void unsetConversion()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CONVERSION$0, 0);
        }
    }
