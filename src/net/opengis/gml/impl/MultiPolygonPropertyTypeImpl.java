 ...
 */
public class MultiPolygonPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.MultiPolygonPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public MultiPolygonPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetMultiPolygon()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(MULTIPOLYGON$0) != 0;
        }
    }
    ...
    public void unsetMultiPolygon()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(MULTIPOLYGON$0, 0);
        }
    }
