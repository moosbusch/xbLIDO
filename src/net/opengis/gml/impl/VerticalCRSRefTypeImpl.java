 ...
 */
public class VerticalCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.VerticalCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public VerticalCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetVerticalCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(VERTICALCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetVerticalCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(VERTICALCRS$0, 0);
        }
    }
