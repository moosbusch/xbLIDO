 ...
 */
public class EngineeringCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.EngineeringCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public EngineeringCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEngineeringCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ENGINEERINGCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetEngineeringCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(ENGINEERINGCRS$0, 0);
        }
    }
