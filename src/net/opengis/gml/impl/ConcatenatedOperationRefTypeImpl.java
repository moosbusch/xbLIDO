 ...
 */
public class ConcatenatedOperationRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ConcatenatedOperationRefType
{
    private static final long serialVersionUID = 1L;
    
    public ConcatenatedOperationRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetConcatenatedOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CONCATENATEDOPERATION$0) != 0;
        }
    }
     ...
     */
     public void setConcatenatedOperation(net.opengis.gml.ConcatenatedOperationType concatenatedOperation)
    {
     ...
     */
    public void unsetConcatenatedOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(CONCATENATEDOPERATION$0, 0);
        }
    }
