 ...
 */
public class TopoPrimitiveMemberTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TopoPrimitiveMemberType
{
    private static final long serialVersionUID = 1L;
    
    public TopoPrimitiveMemberTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTopoPrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TOPOPRIMITIVE$1) != 0;
        }
    }
    ...
    public void unsetTopoPrimitive()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(TOPOPRIMITIVE$1, 0);
        }
    }
