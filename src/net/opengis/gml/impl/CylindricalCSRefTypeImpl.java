 ...
 */
public class CylindricalCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CylindricalCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public CylindricalCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCylindricalCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CYLINDRICALCS$0) != 0;
        }
    }
     ...
     */
     public void setCylindricalCS(net.opengis.gml.CylindricalCSType cylindricalCS)
    {
    ...
    public void unsetCylindricalCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CYLINDRICALCS$0, 0);
        }
    }
