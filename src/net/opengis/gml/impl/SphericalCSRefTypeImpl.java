 ...
 */
public class SphericalCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.SphericalCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public SphericalCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetSphericalCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SPHERICALCS$0) != 0;
        }
    }
    ...
    public void unsetSphericalCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SPHERICALCS$0, 0);
        }
    }
