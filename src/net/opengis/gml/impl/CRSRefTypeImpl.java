 ...
 */
public class CRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public CRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CRS$1) != 0;
        }
    }
    ...
    public void unsetCRS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CRS$1, 0);
        }
    }
