 ...
 */
public class TargetPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TargetPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TargetPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final org.apache.xmlbeans.QNameSet GEOMETRY$3 = org.apache.xmlbeans.QNameSet.forArray( new javax.xml.namespace.QName[] { 
    ...
    public boolean isSetFeature()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(FEATURE$1) != 0;
        }
    }
    ...
    public void unsetFeature()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(FEATURE$1, 0);
        }
    }
    ...
    public net.opengis.gml.AbstractGeometryType getGeometry()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.AbstractGeometryType)get_store().find_element_user(GEOMETRY$3, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetGeometry()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOMETRY$3) != 0;
        }
    }
    ...
    @Inject(optional=true) public void setGeometry(net.opengis.gml.AbstractGeometryType geometry)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (net.opengis.gml.AbstractGeometryType)get_store().add_element_user(GEOMETRY$2);
            }
            target.set(geometry);
        }
    }
    ...
    public void unsetGeometry()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GEOMETRY$3, 0);
        }
    }
