 ...
 */
public class TimeGeometricPrimitivePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeGeometricPrimitivePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeGeometricPrimitivePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeGeometricPrimitive()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMEGEOMETRICPRIMITIVE$1) != 0;
        }
    }
     ...
     */
    public void unsetTimeGeometricPrimitive()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMEGEOMETRICPRIMITIVE$1, 0);
        }
    }
