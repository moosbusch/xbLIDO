 ...
 */
public class ReferenceSystemRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ReferenceSystemRefType
{
    private static final long serialVersionUID = 1L;
    
    public ReferenceSystemRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetReferenceSystem()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(REFERENCESYSTEM$1) != 0;
        }
    }
    ...
    public void unsetReferenceSystem()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(REFERENCESYSTEM$1, 0);
        }
    }
