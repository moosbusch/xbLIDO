 ...
 */
public class GeodeticDatumRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeodeticDatumRefType
{
    private static final long serialVersionUID = 1L;
    
    public GeodeticDatumRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeodeticDatum()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEODETICDATUM$0) != 0;
        }
    }
    ...
    public void unsetGeodeticDatum()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GEODETICDATUM$0, 0);
        }
    }
