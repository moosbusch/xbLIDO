 ...
 */
public class SolidPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.SolidPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public SolidPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetSolid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SOLID$1) != 0;
        }
    }
    ...
    public void unsetSolid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(SOLID$1, 0);
        }
    }
