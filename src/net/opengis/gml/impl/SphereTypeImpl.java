 ...
 */
public class SphereTypeImpl extends net.opengis.gml.impl.AbstractGriddedSurfaceTypeImpl implements net.opengis.gml.SphereType
{
    private static final long serialVersionUID = 1L;
    
    public SphereTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
