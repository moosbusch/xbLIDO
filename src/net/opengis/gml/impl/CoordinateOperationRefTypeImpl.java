 ...
 */
public class CoordinateOperationRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CoordinateOperationRefType
{
    private static final long serialVersionUID = 1L;
    
    public CoordinateOperationRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCoordinateOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COORDINATEOPERATION$1) != 0;
        }
    }
     ...
     */
    public void unsetCoordinateOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COORDINATEOPERATION$1, 0);
        }
    }
