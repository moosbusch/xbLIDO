 ...
 */
public class GeneralTransformationRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeneralTransformationRefType
{
    private static final long serialVersionUID = 1L;
    
    public GeneralTransformationRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeneralTransformation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GENERALTRANSFORMATION$1) != 0;
        }
    }
     ...
     */
    public void unsetGeneralTransformation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(GENERALTRANSFORMATION$1, 0);
        }
    }
