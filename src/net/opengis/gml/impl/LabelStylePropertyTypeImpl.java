/*
 * XML Type:  LabelStylePropertyType
 * Namespace: http://www.opengis.net/gml
 * Java type: net.opengis.gml.LabelStylePropertyType
 *
 ...
 */
public class LabelStylePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.LabelStylePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LabelStylePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLabelStyle()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LABELSTYLE$0) != 0;
        }
    }
    ...
    public void unsetLabelStyle()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(LABELSTYLE$0, 0);
        }
    }
