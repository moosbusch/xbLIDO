 ...
 */
public class ProjectedCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ProjectedCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public ProjectedCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetProjectedCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PROJECTEDCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetProjectedCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(PROJECTEDCRS$0, 0);
        }
    }
