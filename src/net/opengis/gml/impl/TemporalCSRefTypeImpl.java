 ...
 */
public class TemporalCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TemporalCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public TemporalCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTemporalCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TEMPORALCS$0) != 0;
        }
    }
     ...
     */
    public void unsetTemporalCS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TEMPORALCS$0, 0);
        }
    }
