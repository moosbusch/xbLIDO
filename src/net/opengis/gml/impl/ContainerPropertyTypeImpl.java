 ...
 */
public class ContainerPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.ContainerPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public ContainerPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName TOPOSOLID$2 = 
    ...
    public boolean isSetFace()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(FACE$0) != 0;
        }
    }
    ...
    public void unsetFace()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(FACE$0, 0);
        }
    }
    ...
    public net.opengis.gml.TopoSolidType getTopoSolid()
    {
        synchronized (monitor())
        {
            ...
            target = (net.opengis.gml.TopoSolidType)get_store().find_element_user(TOPOSOLID$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetTopoSolid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TOPOSOLID$2) != 0;
        }
    }
    ...
    {
        generatedSetterHelperImpl(topoSolid, TOPOSOLID$2, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public net.opengis.gml.TopoSolidType addNewTopoSolid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            net.opengis.gml.TopoSolidType target = null;
            target = (net.opengis.gml.TopoSolidType)get_store().add_element_user(TOPOSOLID$2);
            return target;
        }
    }
    ...
    public void unsetTopoSolid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(TOPOSOLID$2, 0);
        }
    }
