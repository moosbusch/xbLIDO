 ...
 */
public class CartesianCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CartesianCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public CartesianCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCartesianCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CARTESIANCS$0) != 0;
        }
    }
    ...
    public void unsetCartesianCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CARTESIANCS$0, 0);
        }
    }
