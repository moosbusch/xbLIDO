 ...
 */
public class LineStringPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.LineStringPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public LineStringPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetLineString()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(LINESTRING$0) != 0;
        }
    }
    ...
    public void unsetLineString()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(LINESTRING$0, 0);
        }
    }
