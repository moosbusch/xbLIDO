 ...
 */
public class CompositeSurfacePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CompositeSurfacePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CompositeSurfacePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCompositeSurface()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOSITESURFACE$0) != 0;
        }
    }
    ...
    public void unsetCompositeSurface()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COMPOSITESURFACE$0, 0);
        }
    }
