 ...
 */
public class EllipsoidalCSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.EllipsoidalCSRefType
{
    private static final long serialVersionUID = 1L;
    
    public EllipsoidalCSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEllipsoidalCS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ELLIPSOIDALCS$0) != 0;
        }
    }
    ...
    public void unsetEllipsoidalCS()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ELLIPSOIDALCS$0, 0);
        }
    }
