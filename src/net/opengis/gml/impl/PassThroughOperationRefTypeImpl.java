 ...
 */
public class PassThroughOperationRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.PassThroughOperationRefType
{
    private static final long serialVersionUID = 1L;
    
    public PassThroughOperationRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetPassThroughOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PASSTHROUGHOPERATION$0) != 0;
        }
    }
     ...
     */
    public void unsetPassThroughOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(PASSTHROUGHOPERATION$0, 0);
        }
    }
