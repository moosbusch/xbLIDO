 ...
 */
public class GeometryStylePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.GeometryStylePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public GeometryStylePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetGeometryStyle()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(GEOMETRYSTYLE$0) != 0;
        }
    }
    ...
    public void unsetGeometryStyle()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(GEOMETRYSTYLE$0, 0);
        }
    }
