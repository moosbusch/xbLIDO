 ...
 */
public class DirectedEdgePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.DirectedEdgePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public DirectedEdgePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetEdge()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(EDGE$0) != 0;
        }
    }
    ...
    public void unsetEdge()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(EDGE$0, 0);
        }
    }
