 ...
 */
public class TimeOrdinalEraPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeOrdinalEraPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeOrdinalEraPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeOrdinalEra()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMEORDINALERA$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeOrdinalEra()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMEORDINALERA$0, 0);
        }
    }
