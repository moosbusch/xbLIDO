 ...
 */
public class OperationRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.OperationRefType
{
    private static final long serialVersionUID = 1L;
    
    public OperationRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(OPERATION$1) != 0;
        }
    }
     ...
     */
     public void setOperation(net.opengis.gml.AbstractCoordinateOperationType operation)
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetOperation()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(OPERATION$1, 0);
        }
    }
