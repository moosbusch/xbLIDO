 ...
 */
public class SingleOperationRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.SingleOperationRefType
{
    private static final long serialVersionUID = 1L;
    
    public SingleOperationRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetSingleOperation()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(SINGLEOPERATION$1) != 0;
        }
    }
     ...
     */
    public void unsetSingleOperation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(SINGLEOPERATION$1, 0);
        }
    }
