 ...
 */
public class DerivedCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.DerivedCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public DerivedCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetDerivedCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DERIVEDCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetDerivedCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(DERIVEDCRS$0, 0);
        }
    }
