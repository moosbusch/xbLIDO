 ...
 */
public class CompositeSolidPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CompositeSolidPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public CompositeSolidPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCompositeSolid()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COMPOSITESOLID$0) != 0;
        }
    }
    ...
    public void unsetCompositeSolid()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(COMPOSITESOLID$0, 0);
        }
    }
