 ...
 */
public class TimeClockPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeClockPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeClockPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeClock()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMECLOCK$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeClock()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMECLOCK$0, 0);
        }
    }
