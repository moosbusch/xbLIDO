 ...
 */
public class TimeCalendarPropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TimeCalendarPropertyType
{
    private static final long serialVersionUID = 1L;
    
    public TimeCalendarPropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTimeCalendar()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TIMECALENDAR$0) != 0;
        }
    }
     ...
     */
    public void unsetTimeCalendar()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIMECALENDAR$0, 0);
        }
    }
