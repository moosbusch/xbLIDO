 ...
 */
public class TemporalCRSRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.TemporalCRSRefType
{
    private static final long serialVersionUID = 1L;
    
    public TemporalCRSRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetTemporalCRS()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(TEMPORALCRS$0) != 0;
        }
    }
     ...
     */
    public void unsetTemporalCRS()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TEMPORALCRS$0, 0);
        }
    }
