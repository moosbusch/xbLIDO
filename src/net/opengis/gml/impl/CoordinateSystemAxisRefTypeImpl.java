 ...
 */
public class CoordinateSystemAxisRefTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.CoordinateSystemAxisRefType
{
    private static final long serialVersionUID = 1L;
    
    public CoordinateSystemAxisRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetCoordinateSystemAxis()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(COORDINATESYSTEMAXIS$0) != 0;
        }
    }
     ...
     */
     public void setCoordinateSystemAxis(net.opengis.gml.CoordinateSystemAxisType coordinateSystemAxis)
    {
     ...
     */
    public void unsetCoordinateSystemAxis()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(COORDINATESYSTEMAXIS$0, 0);
        }
    }
