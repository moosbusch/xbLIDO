 ...
 */
public class FeatureStylePropertyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements net.opengis.gml.FeatureStylePropertyType
{
    private static final long serialVersionUID = 1L;
    
    public FeatureStylePropertyTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public boolean isSetFeatureStyle()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(FEATURESTYLE$0) != 0;
        }
    }
    ...
    public void unsetFeatureStyle()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(FEATURESTYLE$0, 0);
        }
    }
