 ...
 */
package org.moosbusch.museum.document.lido.impl;
...
import org.moosbusch.museum.document.lido.spi.AbstractLidoXmlDocument;
 ...
 * @author moosbusch
 */
public class DefaultLidoXmlDocument extends AbstractLidoXmlDocument<DefaultLidoObjectFactory> {

    public DefaultLidoXmlDocument() {
    }

    public DefaultLidoXmlDocument(InputStream in) throws IOException, XmlException {
        super(in);
    }
    ...
    @Override
    protected DefaultLidoObjectFactory createObjectFactory() {
        return new DefaultLidoObjectFactory();
    }
