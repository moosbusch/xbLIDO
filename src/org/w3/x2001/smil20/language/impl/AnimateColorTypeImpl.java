/*
 * XML Type:  animateColorType
 * Namespace: http://www.w3.org/2001/SMIL20/Language
 * Java type: org.w3.x2001.smil20.language.AnimateColorType
 *
 ...
 */
public class AnimateColorTypeImpl extends org.w3.x2001.smil20.impl.AnimateColorPrototypeImpl implements org.w3.x2001.smil20.language.AnimateColorType
{
    private static final long serialVersionUID = 1L;

    public AnimateColorTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.w3.x2001.smil20.language.AnimateColorType.CalcMode.Enum getCalcMode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (org.w3.x2001.smil20.language.AnimateColorType.CalcMode.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.w3.x2001.smil20.language.AnimateColorType.CalcMode xgetCalcMode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.w3.x2001.smil20.language.AnimateColorType.CalcMode target = null;
            target = (org.w3.x2001.smil20.language.AnimateColorType.CalcMode)get_store().find_attribute_user(CALCMODE$44);
            if (target == null)
            {
                target = (org.w3.x2001.smil20.language.AnimateColorType.CalcMode)get_default_attribute_value(CALCMODE$44);
            }
            return target;
        }
    }
     ...
     */
    @Inject(optional=true) public void setCalcMode(org.w3.x2001.smil20.language.AnimateColorType.CalcMode.Enum calcMode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetCalcMode(org.w3.x2001.smil20.language.AnimateColorType.CalcMode calcMode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.w3.x2001.smil20.language.AnimateColorType.CalcMode)get_store().add_attribute_user(CALCMODE$44);
            }
            target.set(calcMode);
        }
    }
     ...
     */
    public static class CalcModeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements org.w3.x2001.smil20.language.AnimateColorType.CalcMode
    {
        private static final long serialVersionUID = 1L;
