 ...
 */
public class SetTypeImpl extends org.w3.x2001.smil20.impl.SetPrototypeImpl implements org.w3.x2001.smil20.language.SetType
{
    ...
    private static final javax.xml.namespace.QName SKIPCONTENT$44 =
    ...
    public boolean getSkipContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SKIPCONTENT$44);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(SKIPCONTENT$44);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetSkipContent()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(SKIPCONTENT$44);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(SKIPCONTENT$44);
            }
            return target;
        }
    }
    ...
    public boolean isSetSkipContent()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(SKIPCONTENT$44) != null;
        }
    }
    ...
    @Inject(optional=true) public void setSkipContent(boolean skipContent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SKIPCONTENT$44);
            }
    ...
    public void xsetSkipContent(org.apache.xmlbeans.XmlBoolean skipContent)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(SKIPCONTENT$44);
            }
    ...
    public void unsetSkipContent()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(SKIPCONTENT$44);
        }
    }
}
